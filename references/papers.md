...
1. 先读 ReAct 的摘要、方法图和一个轨迹例子，理解“推理—行动—观察”；
2. 再读 Toolformer 或 Gorilla 的问题设定，理解工具描述和选择；
3. 学到上下文压缩时读 Lost in the Middle，理解长窗口的非均匀利用；
4. 最后用 SWE-bench 思考：一个 coding agent 的“成功”到底怎样被验证。
